...
/**
 *	@property {Vector2} a.pos - The Base Position of the Box
 * 	@property {Integer} a.angle - The Rotation of the Box
 * 	@property {Object} a.calcpoints - All the Points of the Box
 * 	@property {}
 */

/*
	@property
	a['pos'] - The Base Position of the Box
	a['angle'] - The Rotation of the Box
	a['calc']
